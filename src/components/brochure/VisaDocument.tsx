...
export const VisaDocument = memo(
  ({
    trip,
    flights,
    accommodations,
        ...
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.letterBody}>
            ...
            <Text style={{ marginTop: 10 }}>
              I am submitting this detailed itinerary as part of my visa application for my upcoming
              trip to {trip.tripCountries.map((tc) => tc.countryName).join(", ")}. This document
              outlines my confirmed flight reservations, accommodation bookings, and planned
              activities during my stay.
            </Text>
            <Text style={{ marginTop: 10 }}>
              All accommodations listed have been confirmed, and proof of these bookings is attached
              to my primary application. I intend to strictly adhere to the itinerary provided
              below.
            </Text>
          </View>
                ...
                <View key={i} style={styles.tableRow}>
                  ...
                  <View style={[styles.tableCol, { width: "30%" }]}>
                    <Text>
                      ...
                      {formatTime(f.segments[0].departureTime, f.segments[0].departureTimezone)}) -{" "}
                      {f.segments[f.segments.length - 1].arrivalAirport} (
                      {formatTime(
                        f.segments[f.segments.length - 1].arrivalTime,
                        f.segments[f.segments.length - 1].arrivalTimezone,
                      )}
                      )
                    </Text>
                  </View>
