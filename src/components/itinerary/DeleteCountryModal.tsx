...
import { AlertTriangle, MapPin, Plane, Hotel, Compass } from "lucide-react";
          ...
          >
            <div className="p-6">
              <div className="flex items-center gap-3 text-rose-pastel-500 mb-4">
                ...
                <h3 className="text-lg font-bold text-text-primary">Delete Country?</h3>
              </div>

              <p className="text-sm text-text-secondary leading-relaxed mb-6">
                Are you sure you want to remove{" "}
                <span className="font-bold text-text-primary">{countryName}</span>? This will also
                permanently delete all associated:
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 mb-8">
                <div className="p-3 bg-surface-2 rounded-xl border border-border flex flex-col items-center justify-center text-center">
                  <MapPin size={16} className="text-lavender-500 mb-1" />
                ...
                <div className="p-3 bg-surface-2 rounded-xl border border-border flex flex-col items-center justify-center text-center">
                  <Hotel size={16} className="text-lavender-500 mb-1" />
                  <span className="text-xs font-bold text-text-primary">{counts.stays} Stays</span>
                </div>
                <div className="p-3 bg-surface-2 rounded-xl border border-border flex flex-col items-center justify-center text-center">
                  <Compass size={16} className="text-teal-pastel-500 mb-1" />
                  <span className="text-xs font-bold text-text-primary">
