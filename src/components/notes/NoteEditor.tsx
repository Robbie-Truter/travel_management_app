      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {tips.map((tip, i) => (
            <div
              key={i}
              className="rounded-xl bg-amber-pastel-50 dark:bg-amber-pastel-900/10 border border-amber-pastel-200 dark:border-amber-pastel-800/30 px-4 py-3 text-sm text-[var(--color-text-secondary)]"
            >
              {tip}
            </div>
          ))}
